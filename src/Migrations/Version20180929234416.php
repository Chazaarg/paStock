 ...
 */
final class Version20180929234416 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE producto ADD sub_categoria_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE producto DROP sub_categoria_id');
    }
}
